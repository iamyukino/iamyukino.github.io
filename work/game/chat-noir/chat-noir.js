var block_n = 8, b_reset = 0, n_hurdlehurdle = 1, n_bl_pow = 3;
!function(t){
    var e={};
    function n(o){
        if(e[o])
    ...
    "use strict";
    var o, r = this && this.__extends || (
        o = function (t, e) {
            return (o = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function (t, e) { t.__proto__ = e }
                || function (t, e) { for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]) })(t, e)
        }, function (t, e) {
            function n() {
                this.constructor = t
            }
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            set: function (t) {
                switch (t) {
                    ...
                    case i.WIN: {
                        ...
                        var text = "";
                        if (n_hurdlehurdle == 2)
                            text = "  猫已经无路可走，你赢了！点左下角进入下一关！";
                        else if (n_hurdlehurdle % 3 == 0)
                            text = "  猫偷偷搬走了墙，但还是被围住了！第" + n_hurdlehurdle + "关！";
                        else
                            text = "  猫已经无路可走，你赢了！难度升级！";

                        n_bl_pow *= 0.88;
                        this.setStatusText(f.default(text));
                        b_reset = 1;
                        break;
                    }
                    default: return
            ...
            0 == (1 & e) ? (n = { i: t - 1, j: e - 1 },
                o = { i: t, j: e - 1 }, r = { i: t - 1, j: e + 1 },
                i = { i: t, j: e + 1 }) : (n = { i: t, j: e - 1 },
                o = { i: t + 1, j: e - 1 }, r = { i: t, j: e + 1 },
                i = { i: t + 1, j: e + 1 });
            var l = [];
            ...
            for (var e in s.default.textures)
                this.load.addFile(new c.default(this.load, e, s.default.textures[e], { scale: t }))
        }, e.prototype.create = function () {
                this.createAnimations(), this.createBlocks(), this.createCat(),
                    this.createStatusText(), this.createResetButton(),
                    this.createCreditText(), this.reset(0),
            ...
            if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING)
                return this.setStatusText(f.default("  游戏已经结束，重新开局")), this.reset(0), !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("  点击位置已经是墙了，禁止点击")), !1) :
                this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("  点击位置是猫当前位置，禁止点击")), !1)
                    : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("  猫已经无路可走，你赢了！难度升级！")), this.state = i.WIN, !1)
                        : (this.setStatusText(f.default("您点击了 ") + "(" + t + ", " + e + ")"),
                            block_n += 1,
                            this.cat.step() || (this.setStatusText(f.default("  猫认输，你赢了！难度升级！")), this.state = i.WIN), !0
                        )
                    )
                : (this.setStatusText(f.default("  代码错误，当前位置不存在")), !1)
        },
            e.prototype.reset = function (do_reset_cat = 1) {
                if (b_reset == 1) {
                    this.cat.reset();
                    b_reset = 0, block_n = 8;
                } else if (do_reset_cat == 0){
                    this.cat.reset();
                    block_n = 8;
                } this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("第" + n_hurdlehurdle + "关：点击小圆点，围住小猫"))
            },
            e.prototype.setStatusText = function (t) { this.statusBar.setText(t) },
            ...
            e.prototype.createCat = function () {
                ...
                e.on("escaped", function () { t.state = i.LOSE }),
                    e.on("win", function () { t.state = i.WIN }),
            ...
            e.prototype.createResetButton = function () {
                ...
                this.add.existing(e), e.on("pointerup", function () { t.reset() })
            },
            ...
            e.prototype.resetBlocks = function () {
                this.blocks.forEach(function (t) { t.forEach(function (t) { t.isWall = !1 }) })
            },
            e.prototype.randomWall = function () {
                for (var t = 0; t < block_n * n_bl_pow; t++){
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var o = n(5), r = n(6), i = n(7), s = n(8), a = n(9), l = n(10), d = n(11), h = n(12), u = n(13), f = n(14), p = n(15), c = n(16), k = n(17), g = n(18), w = n(19);
    e.default = {
        textures: {
            bottom_left_1: o, bottom_left_2: r, bottom_left_3: i, bottom_left_4: s, bottom_left_5: a,
            left_1: l, left_2: d, left_3: h, left_4: u, left_5: f,
            top_left_1: p, top_left_2: c, top_left_3: k, top_left_4: g, top_left_5: w
        },
        animations: [
            {
                name: "left_step",
    ...
    var i = n(0), s = function (t) {
        function e(e) {
            var n = this;
            e.credit || (e.credit = "iamyukino.github.io"), e.backgroundColor || (e.backgroundColor = 15658734);
            var o = e.w, r = e.h,
        ...
        return r(e, t), Object.defineProperty(e.prototype, "solver",
            {
                ...
                set: function (t) {
                    this._solver = t;
                    try { this.mainScene.cat.solver = t } finally { }
                },
                enumerable: !0,
                configurable: !0
            }), e
    ...
    var o, r = this && this.__extends || (
        o = function (t, e) {
            return (o = Object.setPrototypeOf || { __proto__: [] } instanceof Array &&
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var i = n(0), s = n(1), a = n(21),
        l = function (t) {
            function e(e) {
                var n = t.call(this, e, 0, 0, "__DEFAULT") || this;
                return n.on("animationrepeat", function () { n.moveForward() }), n.solver = a.default, n.direction = s.default.catDefaultDirection, n.reset(), n
            }
            return r(e, t), Object.defineProperty(e.prototype, "i",
                ...
                e.prototype.stepForward = function () {
                    ...
                    return null !== n && (!n.isWall && (this.play(s.default.directions[this.direction].name + "_step"),
                        this.once("animationcomplete", function () { t.moveForward(), t.resetTextureToStop() }), !0))
                },
    ...
    var i = function (t) {
        function e(e) {
            ...
            return n.setFontSize(o),
                ...
                && (n.setX(e.game.canvas.width / 2), n.setOrigin(.5, 0)), n.setPadding(o, o, o, o), n
        }
        return r(e, t), e
...
function (t, e, n) {
    ...
    var o, r = this && this.__extends || (
        ...
        function (t, e) {
            function n() { this.constructor = t } o(t, e),
            t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }
    );
    Object.defineProperty(e, "__esModule", { value: !0 });
...
function (t, e, n) {
    ...
    var o = n(0), r = function () {
        function t(t, e, n, o) {
            this.i = e, this.j = n, this.isWall = o,
            this.distance = 1 / 0, this.parent = t,
                ...
                for (var e =
                    function () {
                        ...
                        e.neighbours.forEach(function (n) {
                                null === n || n.isEdge || n.isWall || n.distance > e.distance + 1
                                && (n.distance = e.distance + 1, t.indexOf(n) < 0 && t.push(n))
                        })
                    }; t.length > 0;
                ) e()
