!function(e) {
    ...
    (function(o) {
        ...
        !function(n, o) {
            ...
            var l, r, i = n(2), s = {}, c = {}, a = n(3), u = n(4), d = !!(e && e.document && e.document.querySelector && e.addEventListener);
            if ("undefined" != typeof window || d) {
                ...
                return c.destroy = function() {
                    ...
                    l && document.querySelector(s.scrollContainer).removeEventListener("click", this._clickListener, !1)) : (document.removeEventListener("scroll", this._scrollListener, !1),
                ...
                c.init = function(e) {
                    ...
                    c.destroy(),
                    null !== (f = r.selectHeadings(s.contentSelector, s.headingSelector)))) {
                        ...
                        this._scrollListener = o(function(e) {
                            ...
                            (e && (0 === e.eventPhase || null === e.currentTarget) || t) && (l.updateToc(f),
...
, function(e, t) {
    e.exports = function(e) {
        ...
        function l(t) {
            ...
            return t && (l += p + e.collapsibleClass,
            l += p + e.isCollapsedClass),
        ...
        function r() {
            if (e.scrollContainer && document.querySelector(e.scrollContainer))
                ...
                var t = document.documentElement.scrollTop || m.scrollTop;
        ...
        function s(t) {
            if (e.scrollContainer && document.querySelector(e.scrollContainer))
                ...
                var n = document.documentElement.scrollTop || m.scrollTop;
        ...
        function c(t) {
            return -1 !== t.className.indexOf(e.collapsibleClass) && -1 !== t.className.indexOf(e.isCollapsedClass) ? (t.className = t.className.split(p + e.isCollapsedClass).join(""),
            c(t.parentNode.parentNode)) : t
        }
        function a(t) {
...
, function(e, t) {
    e.exports = function(e) {
        ...
        function l(n, l) {
            for (var r = o(n), i = r.headingLevel, s = l, c = t(s), a = c ? c.headingLevel : 0, u = i - a; u > 0; )
                c = t(s),
                c && void 0 !== c.children && (s = c.children),
                u--;
            return i >= e.collapseDepth && (r.isCollapsed = !0),
            s.push(r),
            s
        }
        function r(t, n) {
...
, function(e, t) {
    ...
    function o(e, t) {
        ...
        var r, i, s = window.pageYOffset, c = {
            duration: t.duration,
            offset: t.offset || 0,
            callback: t.callback,
            easing: t.easing || l
