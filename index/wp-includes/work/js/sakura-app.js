...
function cloneObject(a) {
    ...
    if (a instanceof Object) {
        e = {}
        for (c in a)
            a.hasOwnProperty(c) && (e[c] = cloneObject(a[c]))
        return e
    }
}
...
function imgError(ele, type) {
    ...
    case 1:
        if (ele.src.includes('https://cn.gravatar.com/avatar')) {
            ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://iamyukino.github.io/index/wp-content/work/images/global/avatar.png')
        } else {
            ele.src = 'https://iamyukino.github.io/index/wp-content/work/images/global/avatar.png'
        }
        break
    case 2:
        ele.src = 'https://iamyukino.github.io/index/wp-content/work/images/global/avatar.png'
        break
    case 3:
        ele.src = 'https://iamyukino.github.io/index/wp-content/work/images/global/image-404.png'
        break
    default:
        ele.src = 'https://iamyukino.github.io/index/wp-content/work/images/global/image-404.png'
    }
        ...
        for (var i = 0; i < this.files.length; i++) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://iamyukino.github.io/index/wp-content/work/images/global/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
                    lazyload()
...
function checkBgImgCookie() {
    ...
    if (bgurl != '') {
        if (bgurl == 'https://iamyukino.github.io/index/wp-content/work/images/sakura/sakura.png' || bgurl == 'https://iamyukino.github.io/index/wp-content/work/images/sakura/plaid.jpg' || bgurl == 'https://iamyukino.github.io/index/wp-content/work/images/sakura/star.png' || bgurl == 'https://iamyukino.github.io/index/wp-content/work/images/sakura/point.png' || bgurl == 'https://iamyukino.github.io/index/wp-content/work/images/sakura/little-monster.png') {
        ...
        } else if (bgurl == 'https://api.btstu.cn/sjbz/api.php?lx=dongman') {
            mashiro_global.variables.skinSecter = true
...
function checkEffectsCookie() {
    ...
    if (efurl) {
        ...
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/sakura.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/snow.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/line.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/piao.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/coderain.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/pointrain.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "https://iamyukino.github.io/index/wp-includes/work/cdn-cgi/sakura/raindrop.js")
...
$(document).ready(function() {
    ...
    changeBG('#sakura-bg', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/sakura.png')
    changeBG('#gribs-bg', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/plaid.jpg')
    changeBG('#pixiv-bg', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/star.png')
    changeBG('#KAdots-bg', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/point.png')
    changeBG('#totem-bg', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/little-monster.png')
    ...
    $('.skin-menu #dark-bg').click(function() {
        mashiro_global.variables.skinSecter = true
        mashiro_global.variables.isNight = true
        $('body').css('background-image', 'url(https://iamyukino.github.io/index/wp-content/work/images/sakura/dark_bg9.jpg)')
        ...
        $('#banner_wave_2').addClass('banner_wave_hide_fit_skin')
        closeSkinMenu()
        setCookie('bgImgSetting', 'https://iamyukino.github.io/index/wp-content/work/images/sakura/dark_bg9.jpg', 30)
    })
...
function add_copyright() {
    ...
    function setClipboardText(event) {
        ...
        var htmlData = '' + '本内容遵循 CC BY-NC-SA 4.0 版权协议。<br>' + '作者：' + 'iamyukino' + '<br>' + '链接：' + window.location.href + '<br>' + '来源：' + mashiro_option.site_name + '<br><br>' + window.getSelection().toString().replace(/\r\n/g, '<br>')
        var textData = '' + '本内容遵循 CC BY-NC-SA 4.0 版权协议。\n' + '作者：' + 'iamyukino' + '\n' + '链接：' + window.location.href + '\n' + '来源：' + mashiro_option.site_name + '\n\n' + window.getSelection().toString().replace(/\r\n/g, '\n')
